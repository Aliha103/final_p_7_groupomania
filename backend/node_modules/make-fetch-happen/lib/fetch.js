...
const fetch = async (request, options) => {
  ...
  // request url
  const sanitizedUrl = sanitizeUrl(redirect.request.url);
const safeUrl = new URL(sanitizedUrl);
const safeUrlString = safeUrl.toString();
return fetch(safeUrlString, redirect.options);
return fetch(sanitizedUrl, redirect.options);
}
